...
public class DynamicTableWithPagination_notRIght {
...
//counter variable needed for index to find Row for chekckboxes
        int rowCount = 0;
   ...
   //a while loop continues to execute till the condition in the paranthesis is TRUE
        while (notFound) {
            ...
            for (WebElement id : idColumn) {
                ...
                if (personID.equals("42489A")) {
                    System.out.println("The row number of the desired ID is : " + (rowCount + 1));
                    WebElement cechkBox = driver.findElement(By.xpath("//table[@id ='resultTable']/tbody/tr[" + (rowCount + 1) + "]/td[1]"));
                    cechkBox.click();
                    notFound=false;
                    break;
                }
          ...
          //element is not attached to the page document
             //-reason : whenever the DOM refreshes, the link with the webelemt is broken
